...
def function_image():
    """
    Takes and image and write text on it
    :return: image with custom text
    """
...
def video_func():
    """
    Takes a video and write custom text and drwa rectangle on it.
    :return: A video with custom text
    """
